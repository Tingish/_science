...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StructureNode.isUpdate'
        db.add_column(u'_content_structurenode', 'isUpdate',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StructureNode.isUpdate'
        db.delete_column(u'_content_structurenode', 'isUpdate')
