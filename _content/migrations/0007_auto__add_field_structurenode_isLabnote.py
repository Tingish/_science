...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StructureNode.isLabnote'
        db.add_column(u'_content_structurenode', 'isLabnote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StructureNode.isLabnote'
        db.delete_column(u'_content_structurenode', 'isLabnote')
