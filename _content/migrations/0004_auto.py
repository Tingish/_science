...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subscribedUser on 'StructureNode'
        db.create_table(u'_content_structurenode_subscribedUser', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('structurenode', models.ForeignKey(orm[u'_content.structurenode'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'_content_structurenode_subscribedUser', ['structurenode_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field subscribedUser on 'StructureNode'
        db.delete_table('_content_structurenode_subscribedUser')
