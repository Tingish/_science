...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.structureNode'
        db.alter_column(u'_content_rating', 'structureNode_id', self.gf('mptt.fields.TreeOneToOneField')(to=orm['_content.StructureNode'], unique=True, primary_key=True))

        # Changing field 'ViewCount.structureNode'
        db.alter_column(u'_content_viewcount', 'structureNode_id', self.gf('mptt.fields.TreeOneToOneField')(to=orm['_content.StructureNode'], unique=True, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Rating.structureNode'
        db.alter_column(u'_content_rating', 'structureNode_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['_content.StructureNode'], unique=True, primary_key=True))

        # Changing field 'ViewCount.structureNode'
        db.alter_column(u'_content_viewcount', 'structureNode_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['_content.StructureNode'], unique=True, primary_key=True))
    ...
    models = {
        ...
        u'_content.rating': {
            ...
            'structureNode': ('mptt.fields.TreeOneToOneField', [], {'to': u"orm['_content.StructureNode']", 'unique': 'True', 'primary_key': 'True'})
        },
