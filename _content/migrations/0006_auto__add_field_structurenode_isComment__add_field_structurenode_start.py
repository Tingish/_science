...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StructureNode.isComment'
        db.add_column(u'_content_structurenode', 'isComment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StructureNode.start'
        db.add_column(u'_content_structurenode', 'start',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StructureNode.end'
        db.add_column(u'_content_structurenode', 'end',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StructureNode.isComment'
        db.delete_column(u'_content_structurenode', 'isComment')

        # Deleting field 'StructureNode.start'
        db.delete_column(u'_content_structurenode', 'start')

        # Deleting field 'StructureNode.end'
        db.delete_column(u'_content_structurenode', 'end')
