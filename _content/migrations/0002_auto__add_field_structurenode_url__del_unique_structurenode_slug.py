...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'StructureNode', fields ['slug']
        db.delete_unique(u'_content_structurenode', ['slug'])

        # Adding field 'StructureNode.url'
        db.add_column(u'_content_structurenode', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', unique=True, max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StructureNode.url'
        db.delete_column(u'_content_structurenode', 'url')

        # Adding unique constraint on 'StructureNode', fields ['slug']
        db.create_unique(u'_content_structurenode', ['slug'])
