...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Paragraph.isSubhead'
        db.delete_column(u'_content_paragraph', 'isSubhead')

        # Deleting field 'Paragraph.isBlockquote'
        db.delete_column(u'_content_paragraph', 'isBlockquote')

        # Adding field 'StructureNode.isSubhead'
        db.add_column(u'_content_structurenode', 'isSubhead',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'StructureNode.isBlockquote'
        db.add_column(u'_content_structurenode', 'isBlockquote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Paragraph.isSubhead'
        db.add_column(u'_content_paragraph', 'isSubhead',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Paragraph.isBlockquote'
        db.add_column(u'_content_paragraph', 'isBlockquote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'StructureNode.isSubhead'
        db.delete_column(u'_content_structurenode', 'isSubhead')

        # Deleting field 'StructureNode.isBlockquote'
        db.delete_column(u'_content_structurenode', 'isBlockquote')
    ...
    models = {
        ...
        u'_content.structurenode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isBlockquote': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'isSubhead': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
