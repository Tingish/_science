...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.localSource'
        db.alter_column(u'_content_image', 'localSource', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Image.localSource'
        db.alter_column(u'_content_image', 'localSource', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
